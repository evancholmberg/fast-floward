  ...
  render() {
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        description="Sell Kitty Item on the Marketplace" action="kittyItemsMarketSellMarketItem" method="post"
        fields="signer price itemID">
        <account-widget field="signer" label="Signer">
        </account-widget>
        ...
        description="Buy a Kitty Item from the Marketplace Signer: Purchaser, Market Collection Address: Adress with Collection for sale" 
        action="kittyItemsMarketBuyMarketItem" method="post"
        ...
        description="Read the Collection IDs that are for sale" action="kittyItemsMarketReadSaleCollectionIDs" method="get"
        ...
        <action-card title="Day 5: Setup all accounts needed for a user to use the app"
          description="Create all needed accounts for app functionality"
          method="post"
          action="setupAllAccounts"
          fields="signer">
          <account-widget field="signer" label="Signer">
          </account-widget>
        </action-card>
